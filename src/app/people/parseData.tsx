...
export async function parseDataAction(
    ...
    if (!allowedExtensions.has(fileExtension)) {
        return { errorMessage: 'Only .xlsx and .xlsb files are allowed.', result: null };
    }

    if (fileExtension === '.xlsb') {
        return {
            errorMessage: 'officeparser does not support .xlsb files. Upload an .xlsx file to render parsed JSON.',
            result: null,
        };
    }
    ...
    try {
        ...
        return { errorMessage: 'The spreadsheet could not be parsed.', result: null };
    }
}